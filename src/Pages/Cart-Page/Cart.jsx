...
function Cart() {
  ...
  // Shipping cost (fixed) and final total calculation
  ...
  // Input change handler for form data
  ...
  // Format credit card number to 1234 5678 9012 3456
  ...
  // When Checkout is clicked, validate form and show confirm modal
